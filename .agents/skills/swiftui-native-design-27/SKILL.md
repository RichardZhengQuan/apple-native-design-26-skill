---
name: swiftui-native-design-27
description: Design, audit, and implement SwiftUI-native UI and UX for iOS 27, iPadOS 27, and macOS 27. Use when building, modernizing, reviewing, or polishing SwiftUI 27 interfaces, Liquid Glass, native app structure, navigation, task flows, tab bars, toolbars, sidebars, inspectors, search, controls, states, accessibility, SF Symbols, app icons, verification, or official UI kit references.
---
...
is iOS 27, iPadOS 27, or macOS 27. Build the native experience first, then style
...
Keep this skill focused on SwiftUI 27 design decisions.
...
5. Apply SwiftUI 27 treatment after the structure is correct: system surfaces,
...
- Lead with concrete mismatches: missing native APIs, fake system components,
  broken task flow, custom chrome that fights SwiftUI 27 behavior, unreadable
...
- Load `references/swiftui-27-design.md`, `references/ux-contract.md`, and
...
- Add SwiftUI 27 APIs behind availability checks when the project still supports
  earlier OS versions.
...
- Let system navigation, tab bars, sheets, menus, and controls carry the
  SwiftUI 27 visual language before adding custom glass.
...
- Load `references/swiftui-27-design.md` for official source links and distilled
  SwiftUI 27 UI rules.
...
- `build-ios-apps:swiftui-liquid-glass`: iOS/iPadOS 27+ Liquid Glass API usage.
...
- `build-macos-apps:liquid-glass`: macOS 27 Liquid Glass API usage.
